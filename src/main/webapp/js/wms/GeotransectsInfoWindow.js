...
GeotransectsInfoWindow.prototype = {
    ...
    'show': function() {
        ...
        try {
            this.linedesc = this.cswRecord.getDataIdentificationAbstract();
            this.serviceurl = this.cswRecord.getOnlineResources()[0].url;
            this.layername = this.cswRecord.getOnlineResources()[0].name;
            this.linkingLine = "Specific Line information from <a target=_blank href=" + this.cswRecord.getRecordInfoUrl() + ">registry</a>:";
        }
        catch (err) {
